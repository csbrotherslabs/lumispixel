...
def public_page(request, page_key):
    ...
    if page_key == "terms_of_service":
        return render(request, "terms_of_service.html")
    if page_key == "cookie_policy":
        return render(request, "cookie_policy.html")
    if page_key == "accessibility":
