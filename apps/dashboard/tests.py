...
class PhotographerWorkspaceTests(TestCase):
    ...
    def test_bookings_dashboard_structure_navigation_and_states(self):
        ...
        self.assertContains(response, "Block Calendar Time")
        ...
        self.assertContains(response, "10 open actions")
        self.assertContains(response, "contracts awaiting signatures")
        self.assertContains(response, "questionnaires incomplete")
        self.assertContains(response, "potential scheduling conflict")
        self.assertContains(response, "sessions without assigned staff")
