...
urlpatterns = [
    ...
    path("bookings/<int:booking_pk>/contracts/create/", views.contract_create, name="contract_create"),
    path("contracts/<int:pk>/", views.contract_detail, name="contract_detail"),
    path("contracts/<int:pk>/customize/", views.contract_detail, name="contract_customize"),
    ...
    path("settings/contract-templates/<int:pk>/action/", views.contract_template_action, name="contract_template_action"),
    ...
    path("bookings/schedule/<int:pk>/action/", views.booking_action, name="booking_action"),
    path("bookings/mini-sessions/<int:pk>/action/", views.mini_session_action, name="mini_session_action"),
    path("bookings/mini-session-slots/<int:pk>/book/", views.mini_slot_book, name="mini_slot_book"),
    path("bookings/schedule/constraints/<int:pk>/action/", views.constraint_action, name="constraint_action"),
    ...
    path("financial/transactions/export/", views.financial_transaction_export, name="financial_transaction_export"),
    path("financial/transactions/bulk/", views.financial_transaction_bulk, name="financial_transaction_bulk"),
    path("growth/", views.growth_overview, name="growth"),
    path("growth/actions/", views.growth_action, name="growth_action"),
    path("growth/export/", views.growth_export, name="growth_export"),
    ...
    path("invoices/<int:pk>/actions/<str:action>/", views.invoice_action, name="invoice_action"),
