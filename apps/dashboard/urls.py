...
urlpatterns = [
    ...
    path("financial/", views.module_placeholder, {"module_key": "financial_overview"}, name="financial_overview"),
    path("financial/transactions/", views.module_placeholder, {"module_key": "transactions"}, name="transactions"),
