...
def schedule(request):
    """Render the responsive schedule with persisted, studio-scoped booking data."""
    profile = request.studio
    today = timezone.localdate()
    try:
    ...
    events = [{
        ...
        "warnings": ["Contract not signed", "Retainer unpaid", "Questionnaire incomplete"],
    } for session in sessions]

    # The schedule renders only persisted, studio-scoped booking data.
