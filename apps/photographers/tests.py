...
class PhotographerOnboardingTests(TestCase):
    ...
    def test_business_step_location_summary_and_edit_link(self):
        ...
        self.assertContains(response, '<label class="checkbox-option" for="id_willing_to_travel">')
        self.assertContains(response, '<span class="checkbox-option__label">Willing to travel</span>')
