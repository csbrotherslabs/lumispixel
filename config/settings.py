...
ALLOWED_HOSTS = env_list(
    ...
    ["localhost", "127.0.0.1"] if DEBUG else ["lumispixel.com", "www.lumispixel.com"],
)
CSRF_TRUSTED_ORIGINS = env_list(
    "DJANGO_CSRF_TRUSTED_ORIGINS",
    [] if DEBUG else ["https://lumispixel.com", "https://www.lumispixel.com"],
)
...
INSTALLED_APPS = [
    ...
    "apps.photographers.apps.PhotographersConfig", "apps.clients.apps.ClientsConfig",
    "apps.galleries.apps.GalleriesConfig", "apps.ai_engine.apps.AiEngineConfig",
    "apps.broker.apps.BrokerConfig", "apps.marketplace.apps.MarketplaceConfig",
    "apps.billing.apps.BillingConfig", "apps.notifications.apps.NotificationsConfig",
    "apps.dashboard.apps.DashboardConfig", "apps.api.apps.ApiConfig",
]
...
AWS_S3_ENDPOINT_URL = os.getenv("SPACES_ENDPOINT_URL", f"https://{AWS_S3_REGION_NAME}.digitaloceanspaces.com")
AWS_S3_SIGNATURE_VERSION = "s3v4"
AWS_DEFAULT_ACL = None
AWS_QUERYSTRING_AUTH = True
AWS_QUERYSTRING_EXPIRE = int(os.getenv("SPACES_SIGNED_URL_TTL", "900"))
AWS_S3_FILE_OVERWRITE = False
GALLERY_STORAGE_LOCATION = os.getenv("GALLERY_STORAGE_LOCATION", "gallery-originals")
if USE_SPACES and not all([AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_STORAGE_BUCKET_NAME]):
    raise RuntimeError("SPACES_ACCESS_KEY, SPACES_SECRET_KEY and SPACES_BUCKET_NAME are required when USE_SPACES=1.")
